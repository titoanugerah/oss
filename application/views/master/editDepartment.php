      ...
      <div class="row">
        ...
        <div class="card full-height  col-md-12">
          ...
          <div class="card-header">
            ...
            <form class="" action="<?php echo base_url('updateDepartment/'.$department->id); ?>" method="post">
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="form-group col-md-8">
                  ...
                  <input type="text" class="form-control" name="description" value="<?php echo $department->description ?>">
                </div>
            ...
            <div class="card-footer">
              ...
              <a class="btn btn-danger pull-right" href="<?php echo base_url('deleteDepartment/'.$department->id) ?>">Hapus</a>
            </div>
          </form>
