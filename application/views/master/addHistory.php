      ...
      <div class="row">
        ...
        <div class="card full-height  col-md-12">
          ...
          <div class="card-header">
            ...
            <form class="" action="<?php echo base_url('createHistory/'); ?>" method="post">
            <div class="card-body">
              <div class="row">
                ...
                <div class="form-group col-md-4">
                  ...
                  <select class="form-control" name="start_id">
                    <?php foreach ($event as $item): ?>
                      <option class="form-control" value="<?php echo $item->id ?>" ><?php echo $item->day.' jam '.$item->start.' s/d '.$item->end; ?></option>
                    <?php endforeach; ?>
                  </select>
                </div>
                <div class="form-group col-md-4">
